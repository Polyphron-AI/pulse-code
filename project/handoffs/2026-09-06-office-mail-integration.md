...
Verification: 60 focused mail tests passed across server, web, mobile, contracts and shared client. Server, web and shared-client typechecks passed, as did targeted lint. After combining with develop, server and web typechecks, settings/command lint, and 14 focused mail/settings/voice tests passed. Both voice and Mail settings were retained during conflict resolution. The merged lockfile passed a frozen install.
