 ...
 * `~/.t3` that a user's installed Pulse Code runs against.
 *
 ...
 * `PULSE_CODE_HOME` (or its `T3CODE_HOME` alias) counts as an explicit base dir — flipping the state directory
