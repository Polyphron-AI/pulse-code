...
export function createThreadEnvironmentAtoms<R, E>(
  ...
  return {
    ...
    setWatchdog: createEnvironmentCommand(runtime, {
      label: "environment-data:commands:thread:set-watchdog",
      execute: (input: SetThreadWatchdogInput) => setThreadWatchdog(input),
      scheduler,
      concurrency,
    }),
