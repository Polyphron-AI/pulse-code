...
> = {
  ...
  bitbucket: {
    missing:
      "Bitbucket needs API credentials on the server. Set PULSE_CODE_BITBUCKET_EMAIL and PULSE_CODE_BITBUCKET_API_TOKEN, or PULSE_CODE_BITBUCKET_ACCESS_TOKEN.",
    unauthenticated:
      "Bitbucket rejected the configured credentials. Check PULSE_CODE_BITBUCKET_EMAIL and PULSE_CODE_BITBUCKET_API_TOKEN.",
  },
};
