...
const ProviderOptionDescriptorBase = {
  ...
  label: TrimmedNonEmptyString,
  description: Schema.optional(TrimmedNonEmptyString),
  // Display-only: shown greyed out in pickers and never emitted as a
  // selection. Used for provider-global settings (e.g. Hermes context
  // compression) that are visible per-thread but changed in Settings.
