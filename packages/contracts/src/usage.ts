 ...
 * relying on Pulse Code's own orchestration projections, so usage stays complete
 * even for turns that were never driven through Pulse Code. This mirrors the
...
/** v5 adds Grok; v4 Claude and Codex totals remain safe to merge. */
