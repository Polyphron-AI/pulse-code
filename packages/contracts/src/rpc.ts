...
export const WS_METHODS = {
  ...
  pulseMcpGetProjectDefault: PULSE_MCP_METHODS.getProjectDefault,
  pulseMcpSetProjectDefault: PULSE_MCP_METHODS.setProjectDefault,
  pulseMcpResetProjectDefault: PULSE_MCP_METHODS.resetProjectDefault,
...
const WsOrchestrationGenerateThreadHandoffRpc = Rpc.make(
