...
Works with Claude Code, Codex, Cursor, Grok Build, OpenCode, and early-access Oh My Pi. If a provider is installed and authenticated on your computer, Pulse Code can control it.
...
> [!WARNING]
> Pulse Code currently supports Codex, Claude, Cursor, Grok Build, OpenCode, and early-access Oh My Pi. Install and authenticate at least one provider before use:
>
...
- Providers: [Codex](./docs/user/providers-codex.md) · [Claude](./docs/user/providers-claude.md) · [Oh My Pi](./docs/user/providers-omp.md)
