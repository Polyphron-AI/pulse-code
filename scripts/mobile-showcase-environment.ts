// @effect-diagnostics nodeBuiltinImport:off globalTimers:off globalDate:off - This host-side fixture creates an isolated local Pulse Code environment.
...
export const SHOWCASE_PROJECTS = [
  {
    ...
    title: "Pulse Code",
    directory: "t3code",
    repositoryUrl: "https://github.com/Polyphron-AI/pulse-code.git",
...
async function seedCompanionWorkspace(input: {
  ...
  await NodeFSP.writeFile(
    ...
    `# ${input.title}\n\nSeeded by the Pulse Code mobile screenshot harness.\n`,
  );
  await initializeRepository({
