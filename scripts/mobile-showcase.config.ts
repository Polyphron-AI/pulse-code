...
const configuredAndroidAbi =
  process.env.PULSE_CODE_SHOWCASE_ANDROID_ABI ?? process.env.T3_SHOWCASE_ANDROID_ABI;
...
export function resolveShowcaseAndroidAbi(
  ...
  throw new Error(
    `Unsupported PULSE_CODE_SHOWCASE_ANDROID_ABI '${value}'. Use ${ANDROID_ABIS.join(", ")}.`,
  );
}
...
const config: ShowcaseConfig = {
  ...
  devices: [
    ...
    },
    {
      id: "iphone-6.5",
      platform: "ios",
      simulator: "Pulse Code Showcase iPhone 14 Plus",
    ...
    },
    {
      ...
      abi: resolveShowcaseAndroidAbi(configuredAndroidAbi),
      appearance: "dark",
      theme: DEFAULT_SHOWCASE_THEME,
      viewport: {
        width: 1080,
