  ...
  embeds: [
    {
      ...
      description:
        options.target === "prerelease"
          ? "A new Pulse Code prerelease is available for nightly testers."
          : "A new Pulse Code latest release is available.",
...
).pipe(Command.withDescription("Post a Pulse Code release announcement to Discord."));
