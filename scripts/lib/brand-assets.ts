export const BRAND_ASSET_PATHS = {
  ...
  developmentMacIconShellPng: "assets/dev/blueprint-macos-shell-1024.png",

  productionIconComposerProject: "assets/prod/app-icon.icon",
  productionIosIconPng: "assets/prod/black-ios-1024.png",
  productionMacIconPng: "assets/prod/black-macos-1024.png",
  productionMacIconShellPng: "assets/prod/black-macos-shell-1024.png",
  ...
  nightlyMacIconShellPng: "assets/nightly/nightly-macos-shell-1024.png",
