...
- **This computer** runs agents on the computer that hosts Pulse Code. It does not
  require an account.
...
Pulse Code checks the selected computer for Claude Code and Codex. If an agent is
