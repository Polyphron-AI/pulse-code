...
3. Use Pulse PR filters and environment-scoped preferences as the first measured
   vertical slice. The paused old PR import provides comparison evidence, not a
   reviewed implementation to copy wholesale.
