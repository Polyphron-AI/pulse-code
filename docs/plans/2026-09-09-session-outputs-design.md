...
- [ ] Verify baseline and install dependencies.
- [ ] Add saved-output contracts, bounded atomic storage, URL delivery and tests.
- [ ] Capture assistant output links and retain message/turn provenance.
- [ ] Fix web/desktop environment routing and add saved-output download actions; cover mobile.
- [ ] Verify focused tests, scoped typechecks/lint, and review integrated change.
- [ ] Document output retention and recovery behavior.
