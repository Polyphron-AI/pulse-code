...
export const make = Effect.gen(function* () {
  ...
  // the lock would create "Pulse Code (Alpha)" and make the legacy-install
  ...
  return DesktopClerk.of({
    configure: Effect.gen(function* () {
      ...
      // Keep OAuth/deep-link callbacks generated by Pulse Code releases opening
      // the upgraded Pulse Code desktop app during the compatibility window.
