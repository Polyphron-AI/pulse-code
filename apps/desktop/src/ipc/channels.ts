...
export const DOWNLOAD_FILE_CHANNEL = "desktop:download-file";
...
export const UPDATE_LIST_VERSIONS_CHANNEL = "desktop:update-list-versions";
export const UPDATE_ROLLBACK_CHANNEL = "desktop:update-rollback";
