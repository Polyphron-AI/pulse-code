...
const DESKTOP_BACKEND_ENV_NAMES = [
  ...
  "PULSE_CODE_MODE",
  "T3CODE_MODE",
  "PULSE_CODE_NO_BROWSER",
  "T3CODE_NO_BROWSER",
  "PULSE_CODE_HOST",
  "T3CODE_HOST",
  "PULSE_CODE_DESKTOP_WS_URL",
  "T3CODE_DESKTOP_WS_URL",
  "PULSE_CODE_DESKTOP_LAN_ACCESS",
  "T3CODE_DESKTOP_LAN_ACCESS",
  "PULSE_CODE_DESKTOP_LAN_HOST",
  "T3CODE_DESKTOP_LAN_HOST",
  "PULSE_CODE_DESKTOP_HTTPS_ENDPOINTS",
  "T3CODE_DESKTOP_HTTPS_ENDPOINTS",
  "PULSE_CODE_TAILSCALE_SERVE",
  "T3CODE_TAILSCALE_SERVE",
  "PULSE_CODE_TAILSCALE_SERVE_PORT",
...
const resolvePrimaryStartConfig = Effect.fn("desktop.backendConfiguration.resolvePrimary")(
  ...
  > {
    ...
    return {
      ...
      // Primary wants process.env (PATH, dev-runner's PULSE_CODE_HOME, etc.).
      extendEnv: true,
      bootstrap,
...
> {
  ...
  // Build an explicit copy of process.env minus both home aliases (dev-runner
  ...
  for (const [key, value] of Object.entries(process.env)) {
    if (key === "PULSE_CODE_HOME" || key === "T3CODE_HOME") continue;
  ...
  const baseConfig = {
    ...
    // env is already a complete process.env minus the Pulse/Pulse Code home aliases; pass it
