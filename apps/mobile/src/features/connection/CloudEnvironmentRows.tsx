...
interface CloudEnvironmentRowsProps {
  ...
  /**
   * Hide the "Pulse Connect" section title + refresh button for hosts that
...
/**
 * "Pulse Connect" section: every environment published to the signed-in account,
 * with connect switches, availability status, refresh, and loading/error
 * states. Shared between the Settings environments screen and the Pulse Connect
 * onboarding sheet.
 *
