    ...
    const startSession: HermesAdapterShape["startSession"] = (input) =>
      withThreadLock(
        ...
        Effect.gen(function* () {
                ...
                Effect.mapError(
                  (cause) =>
                    new EffectAcpErrors.AcpTransportError({
                      detail: "Failed to process Hermes ACP permission callback.",
                      cause,
                    }),
                ),
              ),
          ...
          const requestedStartModelId = requestedHermesAcpModelIdForSelection(hermesModelSelection);
          ...
          const nf = yield* Stream.runDrain(
            ...
            // notification consumer outlives startSession (see GrokAdapter).
            ...
            return yield* Effect.gen(function* () {
              const turnModelSelection =
                input.modelSelection?.instanceId === boundInstanceId
                  ...
                  : undefined;
              const requestedTurnModelId =
                requestedHermesAcpModelIdForSelection(turnModelSelection);
    ...
    const respondToUserInput: HermesAdapterShape["respondToUserInput"] = (threadId, requestId) =>
      Effect.gen(function* () {
        ...
        return yield* new ProviderAdapterRequestError({
          ...
          detail: `Hermes does not request user input; unknown request: ${requestId}`,
        });
      });
