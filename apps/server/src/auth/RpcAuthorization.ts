...
export const RPC_REQUIRED_SCOPES = {
  [WS_METHODS.mailGetDraft]: AuthOrchestrationReadScope,
  [WS_METHODS.mailGetPeopleContext]: AuthOrchestrationReadScope,
  [WS_METHODS.mailReviewPerson]: AuthOrchestrationOperateScope,
  [WS_METHODS.mailSavePeopleWork]: AuthOrchestrationOperateScope,
  [WS_METHODS.mailReviewConnection]: AuthOrchestrationOperateScope,
  [WS_METHODS.mailGetStatus]: AuthOrchestrationReadScope,
  [WS_METHODS.mailSetEnabled]: AuthAccessWriteScope,
  [WS_METHODS.mailSaveAccount]: AuthAccessWriteScope,
  [WS_METHODS.mailDisconnectAccount]: AuthAccessWriteScope,
  [WS_METHODS.mailListFolders]: AuthOrchestrationReadScope,
  [WS_METHODS.mailCreateFolder]: AuthOrchestrationOperateScope,
  [WS_METHODS.mailRenameFolder]: AuthOrchestrationOperateScope,
  [WS_METHODS.mailDeleteFolder]: AuthOrchestrationOperateScope,
  [WS_METHODS.mailListMessages]: AuthOrchestrationReadScope,
  [WS_METHODS.mailReadMessage]: AuthOrchestrationReadScope,
  [WS_METHODS.mailDownloadAttachment]: AuthOrchestrationReadScope,
  [WS_METHODS.mailDownloadOriginal]: AuthOrchestrationReadScope,
  [WS_METHODS.mailActOnMessages]: AuthOrchestrationOperateScope,
  [WS_METHODS.mailSaveMetadata]: AuthOrchestrationOperateScope,
  [WS_METHODS.mailListDrafts]: AuthOrchestrationReadScope,
  [WS_METHODS.mailSaveDraft]: AuthOrchestrationOperateScope,
  [WS_METHODS.mailDeleteDraft]: AuthOrchestrationOperateScope,
  [WS_METHODS.mailSendDraft]: AuthOrchestrationOperateScope,
  [WS_METHODS.mailListOutbox]: AuthOrchestrationReadScope,
  ...
  [ORCHESTRATION_WS_METHODS.previewThreadHandoff]: AuthOrchestrationReadScope,
  [ORCHESTRATION_WS_METHODS.switchThreadProvider]: AuthOrchestrationOperateScope,
  ...
  [WS_METHODS.issuesGetConnection]: AuthOrchestrationReadScope,
  [WS_METHODS.issuesUpdateConnection]: AuthOrchestrationOperateScope,
  [WS_METHODS.issuesDisconnect]: AuthOrchestrationOperateScope,
  [WS_METHODS.issuesSetProjectMapping]: AuthOrchestrationOperateScope,
  [WS_METHODS.issuesRemoveProjectMapping]: AuthOrchestrationOperateScope,
  ...
  [WS_METHODS.issuesUpdateReport]: AuthOrchestrationOperateScope,
  [WS_METHODS.issuesCreateFromReport]: AuthOrchestrationOperateScope,
  [WS_METHODS.issuesCapture]: AuthOrchestrationOperateScope,
  [WS_METHODS.issuesGetThreadLink]: AuthOrchestrationReadScope,
  [WS_METHODS.issuesGetForThread]: AuthOrchestrationReadScope,
  [WS_METHODS.issuesSetThreadLink]: AuthOrchestrationOperateScope,
  [WS_METHODS.issuesRemoveThreadLink]: AuthOrchestrationOperateScope,
  [WS_METHODS.integrationsListConnections]: AuthOrchestrationReadScope,
  [WS_METHODS.integrationsDisconnect]: AuthOrchestrationOperateScope,
  [WS_METHODS.integrationsSetProjectMapping]: AuthOrchestrationOperateScope,
  [WS_METHODS.integrationsRemoveProjectMapping]: AuthOrchestrationOperateScope,
  [WS_METHODS.integrationsIssueContext]: AuthOrchestrationReadScope,
  [WS_METHODS.integrationsIssuePreviewStatus]: AuthOrchestrationOperateScope,
  [WS_METHODS.integrationsIssueConfirmStatus]: AuthOrchestrationOperateScope,
