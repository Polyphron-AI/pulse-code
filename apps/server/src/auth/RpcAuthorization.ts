...
export const RPC_REQUIRED_SCOPES = {
  ...
  [WS_METHODS.pulseMcpGetProjectDefault]: AuthOrchestrationReadScope,
  [WS_METHODS.pulseMcpSetProjectDefault]: AuthOrchestrationOperateScope,
  [WS_METHODS.pulseMcpResetProjectDefault]: AuthOrchestrationOperateScope,
  ...
  [WS_METHODS.pulseMcpPrepareTurn]: AuthOrchestrationOperateScope,
  [WS_METHODS.pulseMcpDiscover]: AuthOrchestrationReadScope,
  [WS_METHODS.pulseMcpImportDiscovered]: AuthOrchestrationOperateScope,
  [WS_METHODS.pulseMcpNativeInventory]: AuthOrchestrationReadScope,
  [WS_METHODS.pulseMcpSetDiscoveryFollow]: AuthOrchestrationOperateScope,
  [WS_METHODS.pulseSkillsList]: AuthOrchestrationReadScope,
  [WS_METHODS.pulseSkillsMutate]: AuthOrchestrationOperateScope,
  [WS_METHODS.pulseSkillsResolveGitHub]: AuthOrchestrationReadScope,
