...
import Migration0041 from "./Migrations/041_Issues.ts";
import Migration0042 from "./Migrations/042_Integrations.ts";
import Migration0043 from "./Migrations/043_ProjectionThreadsWatchdog.ts";
import Migration0044 from "./Migrations/044_ProjectionProjectSystem.ts";
import Migration0045 from "./Migrations/045_ProjectionThreadsAllowedTools.ts";
...
export const migrationEntries = [
  ...
  [41, "Issues", Migration0041],
  [42, "Integrations", Migration0042],
  [43, "ProjectionThreadsWatchdog", Migration0043],
  [44, "ProjectionProjectSystem", Migration0044],
  [45, "ProjectionThreadsAllowedTools", Migration0045],
] as const;
