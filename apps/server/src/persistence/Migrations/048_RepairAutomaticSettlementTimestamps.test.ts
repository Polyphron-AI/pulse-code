    ...
    Effect.gen(function* () {
      ...
      yield* sql`
        ...
        VALUES
          ...
          (
            'thread-scheduled', 'project-1', 'Scheduled occurrence', ${MODEL_SELECTION}, NULL,
            '2026-05-01T00:00:00.000Z', '2026-09-01T00:00:00.000Z', '2026-06-05T00:00:00.000Z',
            'settled', '2026-09-01T00:00:00.000Z', NULL
          )
      `;
      ...
      assert.deepStrictEqual(yield* runMigrations({ toMigrationInclusive: 48 }), []);
    }),
  );
});
