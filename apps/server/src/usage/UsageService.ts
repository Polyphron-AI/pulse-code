 ...
 *
 * The scan reads the provider CLIs' own session files rather than Pulse Code's
 * orchestration projections, so usage covers turns driven outside Pulse Code too.
