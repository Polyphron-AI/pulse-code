...
export const T3_CHAT_THEME_LABEL = "Pulse Code";
...
// Earlier builds shipped every maintainer theme under a t3- prefix; the flagship
// palette keeps its historical ID. Stored preferences and mixes with the
...
// Older builds stored the dark Pulse Code palette as a separate theme. Keep
...
/**
 * The palette Pulse Code wears with no theme installed, captured from the app's
...
/**
 * The standard Pulse Code look as a theme palette, for seeding a new theme when
 * no theme is installed. Distinct from {@link getDefaultThemeColors}, which
 * carries the flagship Pulse Code palette used to fill roles omitted by theme
 * files.
 */
...
/**
 * The status colors Pulse Code shows without a theme, read from the app's own
