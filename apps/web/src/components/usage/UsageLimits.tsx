...
function LimitWindows({
  ...
  return (
    <div className="grid grid-cols-[7rem_minmax(0,1fr)] gap-x-3 gap-y-1 sm:grid-cols-[11rem_minmax(0,1fr)_7rem] sm:gap-x-4">
      {windows.map((window, index) => {
        ...
        return (
          <Fragment key={window.id}>
            ...
            <span className="col-span-2 mb-2 flex items-center gap-2 text-xs text-muted-foreground tabular-nums sm:col-span-1 sm:mb-0">
...
export function UsageLimitsSection() {
  ...
  const canEditSources =
    ...
    primaryEnvironment.serverConfig?.environment.capabilities.usageLimitSources === true;
