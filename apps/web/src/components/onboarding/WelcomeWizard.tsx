...
// ── Step 2: Pulse Connect (sign in, then connect machines) ──────
...
function ConnectMachinesStep({
  ...
  if (!isLoaded) {
    return <StepShell title="Sign in to Pulse Connect" onBack={onBack} />;
  }

  if (!isSignedIn) {
    return (
      <StepShell
        title="Sign in to Pulse Connect"
  ...
  return (
    <StepShell
      ...
      description={
        hasRemoteMachines
          ? "Connected to your Pulse account."
    ...
    >
      {hasRemoteMachines ? (
          ...
          <Collapsible className="mt-4">
            ...
            <CollapsiblePanel>
              ...
              <p className="mt-2 text-xs text-muted-foreground">
                Keep Pulse Code running on that computer. If it is not running, open Pulse Code or
                run <code className="font-mono">npx t3 serve</code>.
              </p>
            </CollapsiblePanel>
          </Collapsible>
          <div className="mt-7 flex justify-end">
        ...
        <>
          ...
          <p className="mt-2 text-xs text-muted-foreground">
            Keep Pulse Code running on that computer. If it is not running, open Pulse Code or run{" "}
