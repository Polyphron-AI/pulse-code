...
export function WelcomeWizard({
  ...
  return (
    <Dialog open disablePointerDismissal onOpenChange={(_, event) => event.cancel()}>
      ...
      >
        <DialogTitle className="sr-only">Set up Pulse Code</DialogTitle>
        <div className="flex min-h-0 flex-col">
          <DialogHeader className="gap-4">
            <div className="flex items-baseline gap-1.5" role="img" aria-label="Pulse Code">
              <span className="shrink-0 text-sm font-semibold">Pulse Code</span>
  ...
  return (
    ...
    >
      ...
      >
        ...
        <span className="flex-1">Pulse Connect</span>
      ...
      <CollapsiblePanel keepMounted>
        <div className="px-3 pb-3">
          ...
          <p className="mt-3 text-xs text-muted-foreground">
            Keep Pulse Code running. Select the computers you want to set up above.
          </p>
        </div>
      </CollapsiblePanel>
    </Collapsible>
        ...
        <Collapsible>
          ...
          <CollapsiblePanel className="pt-3">
            ...
            <p className="mt-2 text-xs leading-relaxed text-muted-foreground">
              Start Pulse Code first, or run <code className="font-mono">npx t3 serve</code>. Add{" "}
