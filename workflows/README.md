# Pulse Code workflows

Integration workflows describe user and system behavior across clients, the owning Pulse Code
Server, and external providers.

- [Connect and map an integration](connect-and-map-integration.md)
