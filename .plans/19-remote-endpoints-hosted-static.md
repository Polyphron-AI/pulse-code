...
The tunnel fabric can later be Pipenet-derived, Tailscale-derived, or another reverse tunnel implementation. The rest of Pulse Code should only see an `AdvertisedEndpoint`.
